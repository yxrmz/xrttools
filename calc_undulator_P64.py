...
def save_3dMatrix(energy, theta, psi, I0):
#    outDict = {'energy': energy,
#               'theta': theta,
#               'psi': psi,
#               'I0': I0}
    np.savez('I0 vs E vs solidAngle 501x512x512.npz', energy=energy,
             theta=theta, psi=psi, I0=I0)
